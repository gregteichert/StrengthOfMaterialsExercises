...
Note: This version of the problem set is being slightly modified by Greg Teichert so that the correct answer is not given to the student (at least, not for all problems), and the problem ID will also produce different problem inputs compared to the original problem set.
