...
def server(input, output, session):
    ...
    def ui_problem_statement():
        return[ui.markdown(f"Force F<sub>1</sub> = {F1()} lb and F<sub>2</sub> = {F2()} lb are applied to a rubber block of length L = {L()} in. as shown. The depth of the block is {d()} in. Determine the shear strain in the block, assuming ν = 0.49 and E = 500 psi.")]
